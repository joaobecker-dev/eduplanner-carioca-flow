...
import { CalendarEvent, TeachingPlan, LessonPlan, Assessment, Material, Subject, AcademicPeriod } from '@/types';
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <DashboardSummary
        ...
        subjects={subjects}
        annualPlans={[]} // We'll need to fetch this data or pass it from parent
                ...
                <div className="p-4 space-y-4">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex items-start gap-3 animate-pulse">
                      <div className="bg-gray-200 p-2 rounded-md h-14 w-14"></div>
